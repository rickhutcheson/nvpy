...
class NotesList(tk.Frame):
    ...
    def __init__(self, master, font_family, font_size, config):
        ...
        self.text.config(cursor="arrow", foreground="black")
        self.disable_text()
        ...
        self.text.tag_config("pinned", foreground="black")
        ...
        self.text.tag_config("tags", font=italic_font, foreground="black")
        self.text.tag_config("found", font=italic_font, foreground="black", background="lightyellow")

        self.text.tag_config("modifydate", foreground="black")
